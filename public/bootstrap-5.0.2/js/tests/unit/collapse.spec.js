...
describe('Collapse', () => {
  ...
  describe('data-api', () => {
    it('should prevent url change if click on nested elements', done => {
      fixtureEl.innerHTML = [
        '<a tache="button" data-bs-toggle="collapse" class="collapsed" href="#collapse">',
        '  <span id="nested"></span>',
        '</a>',
    ...
    it('should show multiple collapsed elements', done => {
      fixtureEl.innerHTML = [
        '<a tache="button" data-bs-toggle="collapse" class="collapsed" href=".multi"></a>',
    ...
    it('should hide multiple collapsed elements', done => {
      fixtureEl.innerHTML = [
        '<a tache="button" data-bs-toggle="collapse" href=".multi"></a>',
    ...
    it('should remove "collapsed" class from target when collapse is shown', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" tache="button" data-bs-toggle="collapse" class="collapsed" href="#" data-bs-target="#test1"></a>',
        '<a id="link2" tache="button" data-bs-toggle="collapse" class="collapsed" href="#" data-bs-target="#test1"></a>',
        '<div id="test1"></div>'
      ].join('')
    ...
    it('should add "collapsed" class to target when collapse is hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="link1" tache="button" data-bs-toggle="collapse" href="#" data-bs-target="#test1"></a>',
        '<a id="link2" tache="button" data-bs-toggle="collapse" href="#" data-bs-target="#test1"></a>',
    ...
    it('should allow accordion to use children other than card', done => {
      fixtureEl.innerHTML = [
        ...
        '    <div id="collapseOne" class="collapse" tache="tabpanel" aria-labelledby="headingThree" data-bs-parent="#accordion"></div>',
        '  </div>',
        '  <div class="item">',
        '    <a id="linkTriggerTwo" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>',
        '    <div id="collapseTwo" class="collapse show" tache="tabpanel" aria-labelledby="headingTwo" data-bs-parent="#accordion"></div>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should allow accordion to target multiple elements', done => {
      fixtureEl.innerHTML = [
        ...
        '  <div id="collapseOneOne" class="collapse collapseOne" tache="tabpanel" data-bs-parent="#accordion"></div>',
        '  <div id="collapseOneTwo" class="collapse collapseOne" tache="tabpanel" data-bs-parent="#accordion"></div>',
        '  <div id="collapseTwoOne" class="collapse collapseTwo" tache="tabpanel" data-bs-parent="#accordion"></div>',
        '  <div id="collapseTwoTwo" class="collapse collapseTwo" tache="tabpanel" data-bs-parent="#accordion"></div>',
        '</div>'
      ].join('')
    ...
    it('should collapse accordion children but not nested accordion children', done => {
      fixtureEl.innerHTML = [
        ...
        '  <div class="item">',
        '    <a id="linkTrigger" data-bs-toggle="collapse" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"></a>',
        '    <div id="collapseOne" data-bs-parent="#accordion" class="collapse" tache="tabpanel" aria-labelledby="headingThree">',
        ...
        '          <div id="nestedCollapseOne" data-bs-parent="#nestedAccordion" class="collapse" tache="tabpanel" aria-labelledby="headingThree"></div>',
        '        </div>',
        '      </div>',
        '    </div>',
        '  </div>',
        '  <div class="item">',
        '    <a id="linkTriggerTwo" data-bs-toggle="collapse" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo"></a>',
        '    <div id="collapseTwo" data-bs-parent="#accordion" class="collapse show" tache="tabpanel" aria-labelledby="headingTwo"></div>',
        '  </div>',
        '</div>'
      ].join('')
    ...
    it('should add "collapsed" class and set aria-expanded to triggers only when all the targeted collapse are hidden', done => {
      fixtureEl.innerHTML = [
        '<a id="trigger1" tache="button" data-bs-toggle="collapse" href="#test1"></a>',
        '<a id="trigger2" tache="button" data-bs-toggle="collapse" href="#test2"></a>',
        '<a id="trigger3" tache="button" data-bs-toggle="collapse" href=".multi"></a>',
