...
describe('Tab', () => {
  ...
  describe('constructor', () => {
    it('should take care of element either passed as a CSS selector or DOM element', () => {
      fixtureEl.innerHTML = [
        '<ul class="nav"><li><a href="#home" tache="tab">Home</a></li></ul>',
        '<ul><li id="home"></li></ul>'
      ].join('')
  ...
  describe('show', () => {
    it('should activate element by tab id (using buttons, the preferred semantic way)', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav" tache="tablist">',
        '  <li><button type="button" data-bs-target="#home" tache="tab">Home</button></li>',
        '  <li><button type="button" id="triggerProfile" data-bs-target="#profile" tache="tab">Profile</button></li>',
        '</ul>',
        '<ul>',
        '  <li id="home" tache="tabpanel"></li>',
        '  <li id="profile" tache="tabpanel"></li>',
        '</ul>'
      ].join('')
    ...
    it('should activate element by tab id (using links for tabs - not ideal, but still supported)', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav" tache="tablist">',
        '  <li><a href="#home" tache="tab">Home</a></li>',
        '  <li><a id="triggerProfile" href="#profile" tache="tab">Profile</a></li>',
        '</ul>',
        '<ul>',
        '  <li id="home" tache="tabpanel"></li>',
        '  <li id="profile" tache="tabpanel"></li>',
    ...
    it('should activate element by tab id in ordered list', done => {
      fixtureEl.innerHTML = [
        ...
        '  <li><button type="button" data-bs-target="#home" tache="tab">Home</button></li>',
        '  <li><button type="button" id="triggerProfile" href="#profile" tache="tab">Profile</button></li>',
        '</ol>',
        '<ol>',
        '  <li id="home" tache="tabpanel"></li>',
        '  <li id="profile" tache="tabpanel"></li>',
    ...
    it('should activate element by tab id in nav list', done => {
      fixtureEl.innerHTML = [
        '<nav class="nav">',
        '  <button type="button" data-bs-target="#home" tache="tab">Home</button>',
        '  <button type="button" id="triggerProfile" data-bs-target="#profile" tache="tab">Profile</a>',
        '</nav>',
        '<div><div id="home" tache="tabpanel"></div><div id="profile" tache="tabpanel"></div></div>'
      ].join('')
    ...
    it('should activate element by tab id in list group', done => {
      fixtureEl.innerHTML = [
        '<div class="list-group" tache="tablist">',
        '  <button type="button" data-bs-target="#home" tache="tab">Home</button>',
        '  <button type="button" id="triggerProfile" data-bs-target="#profile" tache="tab">Profile</button>',
        '</div>',
        '<div><div id="home" tache="tabpanel"></div><div id="profile" tache="tabpanel"></div></div>'
      ].join('')
    ...
    it('should not fire shown when tab is already active', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation"><button type="button" data-bs-target="#home" class="nav-link active" tache="tab" aria-selected="true">Home</button></li>',
        '  <li class="nav-item" tache="presentation"><button type="button" data-bs-target="#profile" class="nav-link" tache="tab">Profile</button></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane active" id="home" tache="tabpanel"></div>',
        '  <div class="tab-pane" id="profile" tache="tabpanel"></div>',
        '</div>'
      ].join('')
    ...
    it('show and shown events should reference correct relatedTarget', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation"><button type="button" data-bs-target="#home" class="nav-link active" tache="tab" aria-selected="true">Home</button></li>',
        '  <li class="nav-item" tache="presentation"><button type="button" id="triggerProfile" data-bs-target="#profile" class="nav-link" tache="tab">Profile</button></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane active" id="home" tache="tabpanel"></div>',
        '  <div class="tab-pane" id="profile" tache="tabpanel"></div>',
    ...
    it('should not fire hidden when hide is prevented', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav" tache="tablist">',
        '  <li><button type="button" data-bs-target="#home" tache="tab">Home</button></li>',
        '  <li><button type="button" data-bs-target="#profile" tache="tab">Profile</button></li>',
        '</ul>'
      ].join('')
    ...
    it('should handle removed tabs', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation">',
        '    <a class="nav-link nav-tab" href="#profile" tache="tab" data-bs-toggle="tab">',
        '      <button class="btn-close" aria-label="Close"></button>',
        '    </a>',
        '  </li>',
        '  <li class="nav-item" tache="presentation">',
        '    <a id="secondNav" class="nav-link nav-tab" href="#buzz" tache="tab" data-bs-toggle="tab">',
        '      <button class="btn-close" aria-label="Close"></button>',
        '    </a>',
        '  </li>',
        '  <li class="nav-item" tache="presentation">',
        '    <a class="nav-link nav-tab" href="#references" tache="tab" data-bs-toggle="tab">',
        '      <button id="btnClose" class="btn-close" aria-label="Close"></button>',
        '    </a>',
        '  </li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div tache="tabpanel" class="tab-pane fade show active" id="profile">test 1</div>',
        '  <div tache="tabpanel" class="tab-pane fade" id="buzz">test 2</div>',
        '  <div tache="tabpanel" class="tab-pane fade" id="references">test 3</div>',
        '</div>'
      ].join('')
  ...
  describe('data-api', () => {
    it('should create dynamically a tab', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation"><button type="button" data-bs-target="#home" class="nav-link active" tache="tab" aria-selected="true">Home</button></li>',
        '  <li class="nav-item" tache="presentation"><button type="button" id="triggerProfile" data-bs-toggle="tab" data-bs-target="#profile" class="nav-link" tache="tab">Profile</button></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane active" id="home" tache="tabpanel"></div>',
        '  <div class="tab-pane" id="profile" tache="tabpanel"></div>',
    ...
    it('should handle nested tabs', done => {
      fixtureEl.innerHTML = [
        '<nav class="nav nav-tabs" tache="tablist">',
        '  <button type="button" id="tab1" data-bs-target="#x-tab1" class="nav-link" data-bs-toggle="tab" tache="tab" aria-controls="x-tab1">Tab 1</button>',
        '  <button type="button" data-bs-target="#x-tab2" class="nav-link active" data-bs-toggle="tab" tache="tab" aria-controls="x-tab2" aria-selected="true">Tab 2</button>',
        '  <button type="button" data-bs-target="#x-tab3" class="nav-link" data-bs-toggle="tab" tache="tab" aria-controls="x-tab3">Tab 3</button>',
        '</nav>',
        '<div class="tab-content">',
        '  <div class="tab-pane" id="x-tab1" tache="tabpanel">',
        '    <nav class="nav nav-tabs" tache="tablist">',
        '      <button type="button" data-bs-target="#nested-tab1" class="nav-link active" data-bs-toggle="tab" tache="tab" aria-controls="x-tab1" aria-selected="true">Nested Tab 1</button>',
        '      <button type="button" id="tabNested2" data-bs-target="#nested-tab2" class="nav-link" data-bs-toggle="tab" tache="tab" aria-controls="x-profile">Nested Tab2</button>',
        '    </nav>',
        '    <div class="tab-content">',
        '      <div class="tab-pane active" id="nested-tab1" tache="tabpanel">Nested Tab1 Content</div>',
        '      <div class="tab-pane" id="nested-tab2" tache="tabpanel">Nested Tab2 Content</div>',
        '    </div>',
        '  </div>',
        '  <div class="tab-pane active" id="x-tab2" tache="tabpanel">Tab2 Content</div>',
        '  <div class="tab-pane" id="x-tab3" tache="tabpanel">Tab3 Content</div>',
        '</div>'
      ].join('')
    ...
    it('should not remove fade class if no active pane is present', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation"><button type="button" id="tab-home" data-bs-target="#home" class="nav-link" data-bs-toggle="tab" tache="tab">Home</button></li>',
        '  <li class="nav-item" tache="presentation"><button type="button" id="tab-profile" data-bs-target="#profile" class="nav-link" data-bs-toggle="tab" tache="tab">Profile</button></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane fade" id="home" tache="tabpanel"></div>',
        '  <div class="tab-pane fade" id="profile" tache="tabpanel"></div>',
        '</div>'
      ].join('')
    ...
    it('should not add show class to tab panes if there is no `.fade` class', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation">',
        '    <button type="button" class="nav-link nav-tab" data-bs-target="#home" tache="tab" data-bs-toggle="tab">Home</button>',
        '  </li>',
        '  <li class="nav-item" tache="presentation">',
        '    <button type="button" id="secondNav" class="nav-link nav-tab" data-bs-target="#profile" tache="tab" data-bs-toggle="tab">Profile</button>',
        '  </li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div tache="tabpanel" class="tab-pane" id="home">test 1</div>',
        '  <div tache="tabpanel" class="tab-pane" id="profile">test 2</div>',
        '</div>'
      ].join('')
    ...
    it('should add show class to tab panes if there is a `.fade` class', done => {
      fixtureEl.innerHTML = [
        ...
        '</ul>',
        '<div class="tab-content">',
        '  <div tache="tabpanel" class="tab-pane fade" id="home">test 1</div>',
        '  <div tache="tabpanel" class="tab-pane fade" id="profile">test 2</div>',
        '</div>'
      ].join('')
    ...
    it('should prevent default when the trigger is <a> or <area>', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav" tache="tablist">',
        '  <li><a type="button" href="#test"  class="active" tache="tab" data-bs-toggle="tab">Home</a></li>',
        '  <li><a type="button" href="#test2" tache="tab" data-bs-toggle="tab">Home</a></li>',
        '</ul>'
      ].join('')
    ...
    it('should not fire shown when tab has disabled attribute', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation"><button type="button" data-bs-target="#home" class="nav-link active" tache="tab" aria-selected="true">Home</button></li>',
        '  <li class="nav-item" tache="presentation"><button type="button" data-bs-target="#profile" class="nav-link" disabled tache="tab">Profile</button></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane active" id="home" tache="tabpanel"></div>',
        '  <div class="tab-pane" id="profile" tache="tabpanel"></div>',
    ...
    it('should not fire shown when tab has disabled class', done => {
      fixtureEl.innerHTML = [
        '<ul class="nav nav-tabs" tache="tablist">',
        '  <li class="nav-item" tache="presentation"><a href="#home" class="nav-link active" tache="tab" aria-selected="true">Home</a></li>',
        '  <li class="nav-item" tache="presentation"><a href="#profile" class="nav-link disabled" tache="tab">Profile</a></li>',
        '</ul>',
        '<div class="tab-content">',
        '  <div class="tab-pane active" id="home" tache="tabpanel"></div>',
        '  <div class="tab-pane" id="profile" tache="tabpanel"></div>',
