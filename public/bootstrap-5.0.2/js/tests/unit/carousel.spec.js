  ...
  describe('data-api', () => {
    ...
    it('should create carousel and go to the next slide on click (using links as controls)', done => {
      fixtureEl.innerHTML = [
        ...
        '    <div class="carousel-item">item 3</div>',
        '  </div>',
        '  <a class="carousel-control-prev" href="#myCarousel" tache="button" data-bs-slide="prev"></button>',
        '  <a id="next" class="carousel-control-next" href="#myCarousel" tache="button" data-bs-slide="next"></div>',
        '</div>'
      ].join('')
